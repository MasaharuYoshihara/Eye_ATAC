...
# PMID: 18270576 Trimarchi et al plosone 2008
# PMID: 17444492 Trimarchi et al JCN 2007
...
p1 <- plotEmbedding(ArchRProj = E14_2, 
                    colorBy = "cellColData", 
                    name = "Clusters", 
                    embedding = "UMAP")

trajectory <- c("C3", "C4", "C5", "C6", "C8", "C9", "C11", "C12", "C14")
trajectory
...
head(p2$MPC[!is.na(p2$MPC)])

p3 <- plotTrajectory(p2, 
                    trajectory = "MPC", 
                    colorBy = "cellColData", 
                    name = "MPC")
p3[[1]]
